...
; 2.4.2.9.1 Que guarde correctamente
...
Local $indexes = SMDH_ManejoDeCasos_Fuentes_Documental_Get_Idiomas($caso, $fuente)
For $idx = 1 To UBound($indexes) - 1
	SMDH_ManejoDeCasos_Fuentes_Documental_Set_Idioma_Idx($caso, $fuente, $idx)
Next
