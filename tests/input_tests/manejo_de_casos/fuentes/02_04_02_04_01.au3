...
SMDH_ManejoDeCasos_Fuentes_Set_FechaFuente($caso, $fuente, $FECHA_TIPO_VACIO, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Fuentes_Set_FechaFuente($caso, $fuente, $FECHA_TIPO_EXACTA, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Fuentes_Set_FechaFuente($caso, $fuente, $FECHA_TIPO_APROX, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Fuentes_Set_FechaFuente($caso, $fuente, $FECHA_TIPO_NO_DIA, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Fuentes_Set_FechaFuente($caso, $fuente, $FECHA_TIPO_NO_MES, $anio, $mes, $dia)
