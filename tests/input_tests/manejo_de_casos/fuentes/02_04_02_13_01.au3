...
; 2.4.2.13.1 Que guarde correctamente
...
Local $items = SMDH_ManejoDeCasos_Fuentes_Documental_Get_Confiabilidades($caso, $fuente)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Fuentes_Documental_Set_Confiabilidad($caso, $fuente, $items[$i])
	SMDH_ManejoDeCasos_Fuentes_Documental_Remove_Confiabilidad($caso, $fuente)
Next
