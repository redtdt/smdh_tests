...
; 2.4.1.10.1 Que guarde correctamente
...
SMDH_ManejoDeCasos_Fuentes_Set_ExportarFuentePersonal($caso, $fuente, True)
SMDH_ManejoDeCasos_Fuentes_Set_ExportarFuentePersonal($caso, $fuente, False)
SMDH_ManejoDeCasos_Fuentes_Set_ExportarFuentePersonal($caso, $fuente, True)
SMDH_ManejoDeCasos_Fuentes_Set_ExportarFuentePersonal($caso, $fuente, False)
SMDH_ManejoDeCasos_Fuentes_Set_ExportarFuentePersonal($caso, $fuente, True)
