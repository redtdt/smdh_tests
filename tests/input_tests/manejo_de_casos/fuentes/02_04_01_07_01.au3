...
; 2.4.1.7.1 Que guarde correctamente
...
Local $observaciones = "observaciones de una fuente de un caso de prueba para fuentes"
...
SMDH_ManejoDeCasos_Fuentes_Set_Observaciones($caso, $fuente, $observaciones)
