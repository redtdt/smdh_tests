...
; 2.4.2.10.1 Que guarde correctamente
...
Local $items = SMDH_ManejoDeCasos_Fuentes_Documental_Get_LenguasIndigenas($caso, $fuente)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Fuentes_Documental_Set_LenguaIndigena($caso, $fuente, $items[$i])
	SMDH_ManejoDeCasos_Fuentes_Documental_Remove_LenguaIndigena($caso, $fuente)
Next
