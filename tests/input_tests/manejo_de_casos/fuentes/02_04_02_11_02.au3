...
; 2.4.2.11.2 Que guarde correctamente con caracteres especiales

Local $caso = "Caso de pruebas para fuentes"
Local $fuente = "FuenteDocumental"
Local $observaciones = "observaciones de una fuente documental ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Fuentes_Documental_Set_Observaciones($caso, $fuente, $observaciones)
