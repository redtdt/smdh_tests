...
; 2.4.1.9.2 Que guarde correctamente con caracteres especiales
...
Local $comentarios = "comentarios de una fuente de un caso de prueba para fuentes ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Fuentes_Set_Comentarios($caso, $fuente, $comentarios)
