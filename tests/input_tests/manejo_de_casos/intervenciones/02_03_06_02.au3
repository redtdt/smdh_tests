...
; 2.3.6.2 Que guarde correctamente con caracteres especiales
...
Local $tipo = "AcciÛn urgente"
Local $respuesta = "respuesta de una intervencion de un caso de pruebas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Intervenciones_Remove_Set_RespuestaIntervencion($caso, $quien, $tipo, $respuesta)
