...
; 2.3.7.2 Que guarde correctamente con caracteres especiales
...
Local $impacto = "impacto de una intervencion de un caso de pruebas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Intervenciones_Remove_Set_ImpactoIntervencion($caso, $quien, $tipo, $impacto)
