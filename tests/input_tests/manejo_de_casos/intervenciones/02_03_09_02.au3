...
; 2.3.9.2 Que guarde correctamente con caracteres especiales
...
Local $comentarios = "comentarios de una intervencion de un caso de pruebas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Intervenciones_Remove_Set_Comentarios($caso, $quien, $tipo, $comentarios)
