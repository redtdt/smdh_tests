...
SMDH_ManejoDeCasos_Intervenciones_Set_ExportarIntervencions($caso, $quien, $tipo, True)
SMDH_ManejoDeCasos_Intervenciones_Set_ExportarIntervencions($caso, $quien, $tipo, False)
SMDH_ManejoDeCasos_Intervenciones_Set_ExportarIntervencions($caso, $quien, $tipo, True)
SMDH_ManejoDeCasos_Intervenciones_Set_ExportarIntervencions($caso, $quien, $tipo, False)
SMDH_ManejoDeCasos_Intervenciones_Set_ExportarIntervencions($caso, $quien, $tipo, True)
