...
; 2.2.1.7.1 Que guarde correctamente la selección (probar todas las opciones)
...
Local $items = SMDH_ManejoDeCasos_Actos_Get_EstatusVDHs($victima, $violacion)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Actos_Set_EstatusVDH($victima, $violacion, $items[$i])
	SMDH_ManejoDeCasos_Actos_Remove_EstatusVDH($victima, $violacion)
Next
