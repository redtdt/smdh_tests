...
; 2.2.1.6.1 Que guarde correctamente la selección (probar todas las opciones)
...
Local $items = SMDH_ManejoDeCasos_Actos_Get_TiposLugares($victima, $violacion)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Actos_Set_TipoLugar($victima, $violacion, $items[$i])
	SMDH_ManejoDeCasos_Actos_Remove_TipoLugar($victima, $violacion)
Next
