...
; 2.2.1.3.1 Que guarde correctamente
...
SMDH_ManejoDeCasos_Actos_Set_FechaInicial($victima, $violacion, $FECHA_TIPO_VACIO, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Actos_Set_FechaInicial($victima, $violacion, $FECHA_TIPO_EXACTA, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Actos_Set_FechaInicial($victima, $violacion, $FECHA_TIPO_APROX, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Actos_Set_FechaInicial($victima, $violacion, $FECHA_TIPO_NO_DIA, $anio, $mes, $dia)
SMDH_ManejoDeCasos_Actos_Set_FechaInicial($victima, $violacion, $FECHA_TIPO_NO_MES, $anio, $mes, $dia)
