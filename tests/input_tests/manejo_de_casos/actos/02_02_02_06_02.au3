...
; 2.2.2.6.2 Que guarde correctamente con caracteres especiales
...
Local $observaciones = "observaciones de un perpetrador de un caso de prueba para actos ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
