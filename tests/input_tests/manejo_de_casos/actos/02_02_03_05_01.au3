...
; 2.2.3.5.1 Que guarde correctamente
...
SMDH_ManejoDeCasos_Actos_Set_ExportarNormatividad($victima, $violacion, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarNormatividad($victima, $violacion, False)
SMDH_ManejoDeCasos_Actos_Set_ExportarNormatividad($victima, $violacion, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarNormatividad($victima, $violacion, False)
SMDH_ManejoDeCasos_Actos_Set_ExportarNormatividad($victima, $violacion, True)
