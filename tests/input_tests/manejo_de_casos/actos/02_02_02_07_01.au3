...
; 2.2.2.7.1 Que guarde correctamente la selección (probar todas las opciones)
...
SMDH_ManejoDeCasos_Actos_Set_ExportarPerpetrador($victima, $violacion, $perpetrador, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarPerpetrador($victima, $violacion, $perpetrador, False)
SMDH_ManejoDeCasos_Actos_Set_ExportarPerpetrador($victima, $violacion, $perpetrador, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarPerpetrador($victima, $violacion, $perpetrador, False)
