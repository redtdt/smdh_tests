...
; 2.2.2.5.1 Que guarde correctamente la selección (probar todas las opciones)
...
Local $items = SMDH_ManejoDeCasos_Actos_Get_UltimosEstatus($victima, $violacion, $perpetrador)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Actos_Set_UltimoEstatus($victima, $violacion, $perpetrador, $items[$i])
	SMDH_ManejoDeCasos_Actos_Remove_UltimoEstatus($victima, $violacion, $perpetrador)
Next
