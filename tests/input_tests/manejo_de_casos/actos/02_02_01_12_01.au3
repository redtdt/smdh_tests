...
; 2.2.1.12.1 Que guarde correctamente
...
SMDH_ManejoDeCasos_Actos_Set_ExportarActo($victima, $violacion, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarActo($victima, $violacion, False)
SMDH_ManejoDeCasos_Actos_Set_ExportarActo($victima, $violacion, True)
SMDH_ManejoDeCasos_Actos_Set_ExportarActo($victima, $violacion, False)
