...
; 2.2.2.3.1 Que guarde correctamente la selección (probar todas las opciones)
...
Local $items = SMDH_ManejoDeCasos_Actos_Get_GradosInvolucramientos($victima, $violacion, $perpetrador)
For $i = 0 To UBound($items) - 1
	SMDH_ManejoDeCasos_Actos_Set_GradoInvolucramiento($victima, $violacion, $perpetrador, $items[$i])
	SMDH_ManejoDeCasos_Actos_Remove_GradoInvolucramiento($victima, $violacion, $perpetrador)
Next
