...
; 2.5.4.10.2 Que guarde correctamente con caracteres especiales
...
Local $tipo = "Pareja"
Local $comentarios = "comentarios de un dato biografico de una persona ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_Personas_Individual_DatoBiografico_Set_Comentarios($nombre, $apellido, $comentarios)
