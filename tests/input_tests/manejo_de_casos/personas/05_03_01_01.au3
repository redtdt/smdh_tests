...
; 5.2.8.1 Que guarde correctamente
...
SMDH_Personas_Individual_Set_Observaciones($nombre, $apellido, "observacion de una persona individual")
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
...
SMDH_ManejoDeCasos_Personas_InformacionAdministrativa_Open()
SMDH_Personas_Colectiva_Set_Observaciones($colectiva, $sigla, "observacion de una persona colectiva")
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
