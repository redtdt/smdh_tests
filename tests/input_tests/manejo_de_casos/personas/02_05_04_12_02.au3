...
; 2.5.4.12.2 Que guarde correctamente con caracteres especiales
...
Local $tipo = "Pareja"
Local $rango = "Director General ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_Personas_Individual_DatoBiografico_Set_Rango($nombre, $apellido, $rango)
