...
; 2.5.4.9.2 Que guarde correctamente con caracteres especiales
...
Local $tipo = "Pareja"
Local $observaciones = "observaciones de un dato biografico de una persona ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_Personas_Individual_DatoBiografico_Set_Observaciones($nombre, $apellido, $observaciones)
