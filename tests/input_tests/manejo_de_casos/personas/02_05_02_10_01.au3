...
; 2.5.2.10.1 Que guarde correctamente la selección (probar todas las opciones)
...
Local $Monitoreos = SMDH_Personas_Individual_Get_Monitoreos($nombre, $apellido)
For $Monitoreo = 0 To UBound($Monitoreos) - 1
	SMDH_Personas_Individual_Set_Monitoreo_Idx($nombre, $apellido, $Monitoreo)
Next
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
...
SMDH_ManejoDeCasos_Personas_Detalles_Open()
Local $Monitoreos = SMDH_Personas_Colectiva_Get_Monitoreos($colectiva, $sigla)
For $Monitoreo = 0 To UBound($Monitoreos) - 1
	SMDH_Personas_Colectiva_Set_Monitoreo_Idx($colectiva, $sigla, $Monitoreo)
Next
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
