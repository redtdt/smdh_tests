...
; 2.5.4.13.1 Que guarde correctamente
...
Local $tipo = "Pareja"
Local $comentarios = "comentarios de un dato biografico de una persona"
...
SMDH_Personas_Individual_DatoBiografico_Set_ExportarDatoBiografico($nombre, $apellido, True)
SMDH_Personas_Individual_DatoBiografico_Set_ExportarDatoBiografico($nombre, $apellido, False)
SMDH_Personas_Individual_DatoBiografico_Set_ExportarDatoBiografico($nombre, $apellido, True)
SMDH_Personas_Individual_DatoBiografico_Set_ExportarDatoBiografico($nombre, $apellido, False)
SMDH_Personas_Individual_DatoBiografico_Set_ExportarDatoBiografico($nombre, $apellido, True)
