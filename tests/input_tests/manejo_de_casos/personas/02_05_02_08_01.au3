...
; 2.5.2.8.1 Que guarde correctamente
...
SMDH_Personas_Individual_Set_NumeroDependientes($nombre, $apellido, 10)
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
...
SMDH_ManejoDeCasos_Personas_Detalles_Open()
SMDH_Personas_Colectiva_Set_NumeroPersonas($colectiva, $sigla, 10)
SMDH_ManejoDeCasos_Personas_DatosGenerales_Open()
