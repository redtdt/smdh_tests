...
; 2.5.4.6.1 Que guarde correctamente
...
SMDH_Personas_Individual_DatoBiografico_Set_FechaInicial($nombre, $apellido, $FECHA_TIPO_VACIO, $anio, $mes, $dia)
SMDH_Personas_Individual_DatoBiografico_Set_FechaInicial($nombre, $apellido, $FECHA_TIPO_EXACTA, $anio, $mes, $dia)
SMDH_Personas_Individual_DatoBiografico_Set_FechaInicial($nombre, $apellido, $FECHA_TIPO_APROX, $anio, $mes, $dia)
SMDH_Personas_Individual_DatoBiografico_Set_FechaInicial($nombre, $apellido, $FECHA_TIPO_NO_DIA, $anio, $mes, $dia)
SMDH_Personas_Individual_DatoBiografico_Set_FechaInicial($nombre, $apellido, $FECHA_TIPO_NO_MES, $anio, $mes, $dia)
