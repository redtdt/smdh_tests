...
; 2.1.5.4.2 Que guarde correctamente caracterese especiales

Local $caso = "Caso de pruebas"
Local $caso_rel = "Relacionado Caso de pruebas"
Local $comentarios= "Comentarios sobre la relacion de con Relacionado Caso de pruebas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
