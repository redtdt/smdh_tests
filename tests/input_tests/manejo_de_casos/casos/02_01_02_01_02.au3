...
; 2.1.2.1.2 Que guarde correctamente con caracteres especiales

Local $caso = "Caso de pruebas"
Local $obser = "descricion narrativa de un caso de preubas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Casos_Set_DescripcionNarrativa($caso, $obser)
SMDH_ManejoDeCasos_Casos_DatosGenerales_Open()
