...
; 2.1.5.3.2 Que guarde correctamente caracterese especiales

Local $caso = "Caso de pruebas"
Local $caso_rel = "Relacionado Caso de pruebas"
Local $obser= "Observaciones sobre la relacion de con Relacionado Caso de pruebas ·ÈÌÛ˙¡…Õ”⁄Ò~`!@#$%^&*()_-+={}[]|\:;'<>,.?/ø°"
...
SMDH_ManejoDeCasos_Casos_Set_Relacion_Observaciones($caso, $caso_rel, $obser)
